    <div class="content">
      ...
      <form action="<?=base_url('lowongan/update/'.$detail->id_lowongan)?>" role="form" id="updateLowongan" method="post">
        <div class="card-body">
          <a href="<?= base_url('list-lowongan')?>" class="btn btn-sm btn-warning mb-4"><i class="fa fa-solid fa-angle-left" aria-hidden="true"></i> kembali</a>
          <h3><strong>Edit Data Lowongan</strong></h3>
          <div class="mb-3">      
